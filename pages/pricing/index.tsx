...
import { plans, isPlanAtLeast, PlanName } from "src/utils/plans";
...
const PlanCard = ({
    ...
    <Card
        shadow="md"
        borderWidth="1px"
        borderColor={isCurrentPlan ? "green.400" : "gray.200"}
        maxW="sm"
    >
        <CardBody>
                ...
                <Flex direction="column" align="center" w="full" py={10}>
                    <Box textAlign="center" mb={10} px={4}>
                        ...
                        <chakra.p
                            ...
                            mx="auto"
                        >
                            Discover how Videco can improve your B2B company's
                            engagement, conversions, and revenue with
                            interactive video and easy to use platform.
                        </chakra.p>
                        ...
                        <HStack spacing={6} wrap="wrap" justify="center">
                            {plans.map((planItem) => (
                                <PlanCard
                                    ...
                                    isCurrentPlan={
                                        !!plan &&
                                        isPlanAtLeast(plan, planItem.plan_name)
                                    }
                                />
                            ))}
                        </HStack>
